...
The life expectancy and the Gross Domestic Product are important indicators
...
id <- which.min(un$lifeFemale)

# The country with the lowest life expectancy for women is _`r un$country[id]`_ with a life expectancy of _`r un$lifeFemale[id]`_ year.
