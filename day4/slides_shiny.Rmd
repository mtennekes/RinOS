...
Demo: https://shiny.posit.co/r/gallery/widgets/widget-gallery/
...
Always consists of two functions: a placeholder in the UI and a rendering function in the server
...
Create a Shiny dashboard with `library(shinydashboard)`. 
For more information: https://rstudio.github.io/shinydashboard/index.html

Statistics Netherlands website with Shiny dashboards: https://dashboards.cbs.nl/ 
