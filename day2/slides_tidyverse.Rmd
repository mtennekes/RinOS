...
- number of standard and documented functions.
...
## Syntactic sugar: data pipelines

The operator `%>%` passes the output of the left side through as the first argument
...
## Syntactic sugar: data pipelines (2)
...
Can also be written (which may be more clear for you...)
...
- The directory separator is _always the forward slash
...
### Het `foreign` package (standaard bij R)
